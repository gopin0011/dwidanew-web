...
<link rel='stylesheet' id='wp-block-library-css' href="{{asset('public/assets/wp-includes/style.min.css?ver=6.1.1')}}" media='all' />
...
<link rel='stylesheet' id='classic-theme-styles-css' href="{{asset('public/assets/wp-includes/classic-themes.min.css?ver=1')}}" media='all' />
...
<link data-minify="1" rel='stylesheet' id='wpml-blocks-css' href="{{asset('public/assets/wp-content/cache/sitepress-multilingual-cms/styles.css?ver=1682258217')}}" media='all' />
...
<link data-minify="1" rel="stylesheet" href="{{asset('public/assets/wp-content/jem7gzh.css?ver=1682258218')}}">
<link data-minify="1" href="{{asset('public/assets/wp-content/omgf-stylesheet-75.css?ver=1682258218')}}" rel="stylesheet">
...
<div style="background-color: #fff;">
    <div class="container">
            ...
            <div class="source2">
                <div class="SiteHeader-submenu mt-5">
                    <div class="SiteHeader-submenu-container container">
                        <div class="scrollable-list">
                            <ul class="scrollable-ul">
                                @foreach($category as $cat)
                                <li class="{{ request()->route('catId') == $cat->id ? 'is-active' : '' }}"><a href="{{route('app.product', ['catId' => $cat->id])}}">{{$cat->name}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row mb-5">
                <div class="col-12 p-CollectionList-mainCol">
                    <div class="row">
                        @foreach($categoryProduct->product as $product)
                        <article class="col-6 p-CollectionList-col is-inview" data-scroll="">
                            ...
                            <p class="text-light p-CollectionList-subtitle">{{$product->subtitle}}</p>
                            </a>
                        </article>
                        @endforeach
                    </div>
       ...
       $(document).ready(function() {
          ...
          // Portfolio isotope and filter
            ...
            $('#portfolio-flters li').on('click', function () {
                ...
                if ($(this).data('filter') != "*") {
                    $class = $(this).data('filter') + " .portfolio-img";
                    $($class + ' .lightbox-cats').magnificPopup({ 
                        type: 'image',
                        gallery:{enabled:true}
                        // other options
                    });
            ...
            // Toggle menu dropdown saat menu burger di klik
            document.querySelector('.SiteHeader-burger').addEventListener('click', function() {
                document.querySelector('.SiteHeader-dropdown').classList.toggle('open');
            });
       });
    </script>
@endsection