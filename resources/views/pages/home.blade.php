                                            ...
                                            <div class="fl-module-content fl-node-content">
                                                <div class="fl-photo fl-photo-align-center" itemscope itemtype="https://schema.org/ImageObject">
                                                    ...
                                                    <picture decoding="async" class="fl-photo-img wp-image-798 size-large" itemprop="image">
                                                        <source type="image/webp" data-lazy-srcset="{{asset('images/13_.jpg')}} 1024w, {{asset('images/13_.jpg')}} 300w, {{asset('images/13_.jpg')}} 768w, {{asset('images/13_.jpg')}} 1536w, {{asset('images/13_.jpg')}} 2048w, {{asset('images/13_.jpg')}} 50w, {{asset('images/13_.jpg')}} 100w" srcset="data:image/svg+xml,%3Csvg%20xmlns=&#039;http://www.w3.org/2000/svg&#039;%20viewBox=&#039;0%200%201024%20683&#039;%3E%3C/svg%3E" data-lazy-sizes="(max-width: 1024px) 100vw, 1024px"/>
                                                        <img decoding="async" src="data:image/svg+xml,%3Csvg%20xmlns=&#039;http://www.w3.org/2000/svg&#039;%20viewBox=&#039;0%200%201024%20683&#039;%3E%3C/svg%3E" alt="Toyota Forklift AGV - Autonomous Navigation Technology" itemprop="image" height="683" width="1024" data-lazy-srcset="{{asset('images/13_.jpg')}} 1024w, {{asset('images/13_.jpg')}} 300w, {{asset('images/13_.jpg')}} 768w, {{asset('images/13_.jpg')}} 1536w, {{asset('images/13_.jpg')}} 2048w, {{asset('images/13_.jpg')}} 24w, {{asset('images/13_.jpg')}} 50w, {{asset('images/13_.jpg')}} 100w, {{asset('images/13_.jpg')}} 75w, {{asset('images/13_.jpg')}} 36w, {{asset('images/13_.jpg')}} 48w" data-lazy-sizes="(max-width: 1024px) 100vw, 1024px" data-lazy-src="{{asset('images/13_.jpg')}}"/>
                                                    </picture>
                                                    <noscript>
                                                        <picture decoding="async" class="fl-photo-img wp-image-798 size-large" itemprop="image">
                                                            <source type="image/webp" srcset="{{asset('images/13_.jpg')}} 1024w, {{asset('images/13_.jpg')}} 300w, {{asset('images/13_.jpg')}} 768w, {{asset('images/13_.jpg')}} 1536w, {{asset('images/13_.jpg')}} 2048w, {{asset('images/13_.jpg')}} 50w, {{asset('images/13_.jpg')}} 100w" sizes="(max-width: 1024px) 100vw, 1024px"/>
                                                            <img decoding="async" src="{{asset('images/13_.jpg')}}" alt="Toyota Forklift AGV - Autonomous Navigation Technology" itemprop="image" height="683" width="1024" srcset="{{asset('images/13_.jpg')}} 1024w, {{asset('images/13_.jpg')}} 300w, {{asset('images/13_.jpg')}} 768w, {{asset('images/13_.jpg')}} 1536w, {{asset('images/13_.jpg')}} 2048w, {{asset('images/13_.jpg')}} 24w, {{asset('images/13_.jpg')}} 50w, {{asset('images/13_.jpg')}} 100w, {{asset('images/13_.jpg')}} 75w, {{asset('images/13_.jpg')}} 36w, {{asset('images/13_.jpg')}} 48w" sizes="(max-width: 1024px) 100vw, 1024px"/>
                                                        </picture>
                                                    </noscript>
                                                    </div>
                                                </div>
