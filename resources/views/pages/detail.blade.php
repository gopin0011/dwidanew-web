                              ...
                              <div class="fl-slide fl-slide-0 fl-slide-text-right">
                                 <div class="fl-slide-mobile-photo">
                                    <picture decoding="async" loading="false" class="fl-slide-mobile-photo-img wp-image-2264">
                                       <source type="image/webp" data-lazy-srcset="{{ asset('storage/products/'.$product->image[0]->media->desktop) }} 1024w, {{ asset('storage/products/'.$product->image[0]->media->desktop) }} 300w, {{ asset('storage/products/'.$product->image[0]->media->desktop) }} 768w, {{ asset('storage/products/'.$product->image[0]->media->desktop) }} 1536w, {{ asset('storage/products/'.$product->image[0]->media->desktop) }} 50w, {{ asset('storage/products/'.$product->image[0]->media->desktop) }} 100w, {{ asset('storage/products/'.$product->image[0]->media->desktop) }} 150w, {{ asset('storage/products/'.$product->image[0]->media->desktop) }} 1920w" srcset="data:image/svg+xml,%3Csvg%20xmlns=&#039;http://www.w3.org/2000/svg&#039;%20viewBox=&#039;0%200%201024%20683&#039;%3E%3C/svg%3E" data-lazy-sizes="(max-width: 1024px) 100vw, 1024px"/>
                                       <img decoding="async" width="1024" height="683" loading="false" src="data:image/svg+xml,%3Csvg%20xmlns=&#039;http://www.w3.org/2000/svg&#039;%20viewBox=&#039;0%200%201024%20683&#039;%3E%3C/svg%3E" alt="BlueBotics Autonomous Navigation drives the F3 Nipper AGV" data-lazy-srcset="{{ asset('storage/products/'.$product->image[0]->media->desktop) }} 1024w, https://bluebotics.com/wp-content/uploads/2020/12/3-BlueBotics_autonomous_navigation_2019-F3-Design-3x-Nipper-300x200.jpg 300w, https://bluebotics.com/wp-content/uploads/2020/12/3-BlueBotics_autonomous_navigation_2019-F3-Design-3x-Nipper-768x512.jpg 768w, https://bluebotics.com/wp-content/uploads/2020/12/3-BlueBotics_autonomous_navigation_2019-F3-Design-3x-Nipper-1536x1024.jpg 1536w, https://bluebotics.com/wp-content/uploads/2020/12/3-BlueBotics_autonomous_navigation_2019-F3-Design-3x-Nipper-50x33.jpg 50w, https://bluebotics.com/wp-content/uploads/2020/12/3-BlueBotics_autonomous_navigation_2019-F3-Design-3x-Nipper-100x67.jpg 100w, https://bluebotics.com/wp-content/uploads/2020/12/3-BlueBotics_autonomous_navigation_2019-F3-Design-3x-Nipper-150x100.jpg 150w, https://bluebotics.com/wp-content/uploads/2020/12/3-BlueBotics_autonomous_navigation_2019-F3-Design-3x-Nipper.jpg 1920w" data-lazy-sizes="(max-width: 1024px) 100vw, 1024px" data-lazy-src="{{ asset('storage/products/'.$product->image[0]->media->desktop) }}"/>
                                    </picture>
                                    <noscript>
                                       <picture decoding="async" loading="false" class="fl-slide-mobile-photo-img wp-image-2264">
                                          <source type="image/webp" srcset="{{ asset('storage/products/'.$product->image[0]->media->desktop) }} 1024w, {{ asset('storage/products/'.$product->image[0]->media->desktop) }} 300w, {{ asset('storage/products/'.$product->image[0]->media->desktop) }} 768w, {{ asset('storage/products/'.$product->image[0]->media->desktop) }} 1536w, {{ asset('storage/products/'.$product->image[0]->media->desktop) }} 50w, {{ asset('storage/products/'.$product->image[0]->media->desktop) }} 100w, {{ asset('storage/products/'.$product->image[0]->media->desktop) }} 150w, {{ asset('storage/products/'.$product->image[0]->media->desktop) }} 1920w" sizes="(max-width: 1024px) 100vw, 1024px"/>
                                          <img decoding="async" width="1024" height="683" loading="false" src="{{ asset('storage/products/'.$product->image[0]->media->desktop) }}" alt="BlueBotics Autonomous Navigation drives the F3 Nipper AGV" srcset="{{ asset('storage/products/'.$product->image[0]->media->desktop) }} 1024w, https://bluebotics.com/wp-content/uploads/2020/12/3-BlueBotics_autonomous_navigation_2019-F3-Design-3x-Nipper-300x200.jpg 300w, https://bluebotics.com/wp-content/uploads/2020/12/3-BlueBotics_autonomous_navigation_2019-F3-Design-3x-Nipper-768x512.jpg 768w, https://bluebotics.com/wp-content/uploads/2020/12/3-BlueBotics_autonomous_navigation_2019-F3-Design-3x-Nipper-1536x1024.jpg 1536w, https://bluebotics.com/wp-content/uploads/2020/12/3-BlueBotics_autonomous_navigation_2019-F3-Design-3x-Nipper-50x33.jpg 50w, https://bluebotics.com/wp-content/uploads/2020/12/3-BlueBotics_autonomous_navigation_2019-F3-Design-3x-Nipper-100x67.jpg 100w, https://bluebotics.com/wp-content/uploads/2020/12/3-BlueBotics_autonomous_navigation_2019-F3-Design-3x-Nipper-150x100.jpg 150w, https://bluebotics.com/wp-content/uploads/2020/12/3-BlueBotics_autonomous_navigation_2019-F3-Design-3x-Nipper.jpg 1920w" sizes="(max-width: 1024px) 100vw, 1024px"/>
                                       </picture>
                                    </noscript>
                                 </div>
