...
<div class="uabb-js-breakpoint" style="display: none;"></div>
<div class="fl-row fl-row-full-width fl-row-bg-none fl-node-5f7e027ea8390" data-node="5f7e027ea8390" style="margin-top: 50px;">
                     ...
                     <div class="fl-module-content fl-node-content">
                        <div class="fl-rich-text">
                           <p><b>“Give the best services”</b><br>
                              by giving guarantee that the customer will receive our maximum service, for instance in quality product, easiness, along with competitive expense
                           </p>
                        </div>
                     </div>
                  </div>
                              ...
                              <div class="fl-slide fl-slide-1 fl-slide-text-right">
                                 ...
                                 <div class="fl-slide-foreground clearfix">
                                    <div class="fl-slide-content-wrap">
                                       <div class="fl-slide-content">
                                          <div class="fl-slide-text">
                                             <p>Good quality and reasonable expanse to fulfill its consumer’s satisfaction</p>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="fl-slide-photo-wrap">
                              ...
                              <div class="fl-slide fl-slide-2 fl-slide-text-right">
                                 ...
                                 <div class="fl-slide-foreground clearfix">
                                    <div class="fl-slide-content-wrap">
                                       <div class="fl-slide-content">
                                          <div class="fl-slide-text">
                                             <p>Supported with high quality technologies hoped to be able to complete in all education aspects</p>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="fl-slide-photo-wrap">
